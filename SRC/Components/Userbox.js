...
const Userbox = ({data}) => {
  return (
    ...
    <View style={styles.image_Style}>
        <CustomImage style={{width: windowHeight * 0.06, height: windowHeight * 0.06}} source={data.image}/>
    </View>
    <View style={{width:windowWidth*0.55,marginLeft:moderateScale(20,0.6)}}>
    <CustomText style={{fontSize:moderateScale(20,0.6),
        color:Color.themeBlack
    }}>{data.userID}</CustomText>
    <CustomText style={{fontSize:moderateScale(12,0.6),
        color:Color.themeDarkGray,
    }}>{data.subtext}</CustomText>
    </View>
    <CustomText style={{fontSize:moderateScale(12,0.6),
        color:Color.themeDarkGray,
    ...
    <CustomText style={{
        fontSize:moderateScale(12,0.6),color:Color.themeDarkGray,
        marginLeft:moderateScale(5,0.6)
    }}>{data.fromLocation}</CustomText>
    </View>
    <View style= {{transform: [{ rotate: '90deg'}],
    position:'absolute',width:windowWidth *0.1,
    top:moderateScale(25,0.6),left:moderateScale(-4,0.6)
}}>
    ...
    <Icon  name='location-outline' as={Ionicons} size={moderateScale(18,0.6)}/>
    <CustomText style={{
        fontSize:moderateScale(12,0.6),color:Color.themeDarkGray,marginLeft:moderateScale(5,0.6)
    }}>{data.toLocation}</CustomText>
    </View>
    </View>
