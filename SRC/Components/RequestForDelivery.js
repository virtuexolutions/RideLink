...
const RequestForDelivery = ({setRef, rbRef, item}) => {
  ...
  const deliveryRequest = async () => {
    ...
    const body = {
      pickup_location: item?.pickupLocation?.name,
      destination_location: item?.dropLocation?.name,
    ...
    <RBSheet
      ...
      <View
        ...
        <View>
          ...
          <TextInputWithTitle
            titleText={'Details'}
            placeholder={'Details and photo to the address'}
