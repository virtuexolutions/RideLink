...
const RateScreen = () => {
  return (
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.box}>
          ...
          <CustomText style={{
            ...
            fontWeight:'bold',color:Color.themeBlack,
            width:windowWidth *0.45,marginLeft:moderateScale(13,0.6)
          }}>Theodora J. Gardner</CustomText>
        ...
        <Icon style={{color:Color.white}} as={FontAwesome5} name='car' size={moderateScale(12,0.6)}/>
        </View>
        <View style={{marginLeft:moderateScale(10,0.6)}}>
        <CustomText style={{fontSize:moderateScale(12,0.6),
            color:Color.themeBlack,fontWeight:'bold'
        }}>Pickup</CustomText>
    ...
    position:'absolute',width:windowWidth *0.1,top:moderateScale(30,0.6),
    left:moderateScale(-4,0.6)
        ...
        <CustomText style={{fontSize:moderateScale(10,0.6),
            color:Color.themeBlack,fontWeight:'bold'
        }}>Neville Street Salem, Colorado</CustomText>
        </View>
        </View>
        </View>
        </View>
        ...
        <View style={{flexDirection:'row',justifyContent:'space-between'}}>
            <CustomText style={{fontSize:moderateScale(12,0.6),
                color:Color.themeBlack ,fontWeight:'600'
            }}>Trip Fare Breakdown</CustomText>
            <CustomText style={{fontSize:moderateScale(12,0.6),
        ...
        <View style={{flexDirection:'row',justifyContent:'space-between',
            ...
            <CustomText isBold style={{fontSize:moderateScale(16,0.6),
                color:Color.themeBlack
            }}>Total</CustomText>
            <CustomText isBold style={{fontSize:moderateScale(16,0.6),
                color:Color.themeBlack
